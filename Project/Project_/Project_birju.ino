...
const char* mqtt_server = "192.168.43.234";
...
void loop() {
 ...
 // client.loop();
  ...
  if (isnan(event.relative_humidity)) {
    ...
    Serial.print(humid);
    Serial.println("%");
    payload = "{\"AirTemperature\":"+temp+","+"\"AirHumidity\":"+humid+","+"\"SoilMoisture\":"+ms.getSmoothedReading()+","+"\"SoilTemperature\":"+temperatureCString+"}";
  ...
  int m=int(ms.getSmoothedReading()-'0');
